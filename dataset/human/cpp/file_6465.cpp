...
#ifdef DEBUG
    assert(288 == aux2("LLLRRLRR"));
    assert(288 == solve("BWBBWWWB"));
    assert(4 == aux2("LLRR"));
    assert("LLRR" == aux1("BWWB"));
    assert(4 == solve("BWWB"));
#endif
