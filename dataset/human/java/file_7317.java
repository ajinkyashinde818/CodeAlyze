...
public class Main {
    ...
    static boolean match(int index, String word) {
//        debug("index=" + index + ", word=" + word);
        return index - word.length() >= 0 && s.substring(index - word.length(), index).equals(word);
    }
